...

{
  options = {
    ...
    Umask = mkOption {
      ...
      default = null;
      description = ''
        This optional key specifies what value should be passed to <literal>umask(2)</literal> before running the job.
      '';
      apply = u: if isString u then fromOctalStr u else u;
    };
